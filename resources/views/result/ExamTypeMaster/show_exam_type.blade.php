                            ...
                            <table id="example" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                        ...
                                        <td>
                                            <div class="d-inline">
                                                <a href="{{ route('exam_type_master.edit',$data->Id)}}" class="btn btn-info btn-outline">
                                                    <i class="ti-pencil-alt"></i>
                                                </a>
                                            </div>
                                            <form class="d-inline" action="{{ route('exam_type_master.destroy', $data->Id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
