    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Add Grievance</h4> </div>
        </div>
        ...
        <div class="card">
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <form action="{{ route('complaint.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label>Date </label>
                                <input type="text" required name='DATE' class="form-control mydatepicker" autocomplete="off">
                            </div>
                        ...
                        <div class="col-md-4 form-group ml-0 mr-auto">
                            <label for="input-file-now">Attachment</label>
                            <input type="file" name="ATTACHEMENT" id="input-file-now" class="dropify" />
                        </div>
