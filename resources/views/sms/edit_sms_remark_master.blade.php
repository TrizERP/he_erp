        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('sms_remark_master.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="number" name="sort_order" value="{{ $data->sort_order }}" required class="form-control">
                            </div>
                            ...
                            <div class="col-md-12 form-group text-center">
                                ...
                                <a href="{{ route('sms_remark_master.index') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
