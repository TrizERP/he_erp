...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            @endif
                <form action="{{ route('notification_report.create') }}" enctype="multipart/form-data" class="row">
                    @csrf
    ...
    // Setup - add a text input to each footer cell    
     ...
     var table = $('#example').DataTable( {
        ...
        buttons: [ 
            ...
            { extend: 'csv', text: ' CSV', title: 'Notification Report' }, 
            { extend: 'excel', text: ' EXCEL', title: 'Notification Report' }, 
            { extend: 'print', text: ' PRINT', title: 'Notification Report' },
            'pageLength' 
        ], 
        }); 
