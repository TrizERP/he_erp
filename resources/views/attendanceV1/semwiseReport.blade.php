                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        customize: function(win) {
                            ...
                            // 2️⃣ Clone original real header and add to print table
                            var originalHead = $('#example thead').clone();
                            $(win.document.body).find('table').prepend(originalHead);

                            // 3️⃣ Ensure browser prints both header rows correctly
                            $(win.document.body).find('table thead').css('display',
                                'table-header-group');
