...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row bg-title">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h4 class="page-title">Level Master</h4>
			</div>
		</div>
	...
	<div class="card">
		...
		<form action="{{route('insert_naac_master.store')}}" method="Post">
			<div class="row">
				@csrf
				...
				<div class="col-md-3 form-group">
					...
					<textarea type="text" row="5" id="description" name="description" placeholder="Enter Description" class="form-control"></textarea>
				</div>
