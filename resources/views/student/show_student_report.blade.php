        ...
        @if(isset($data['student_data']))
            ...
            <div class="card mt-4 shadow-sm">
                <div class="table-responsive p-4" id="printPage">
                    @php
                        // ✅ Academic Year label first
                        echo '<div style="text-align:center; margin-bottom:3px;">
                                <span style="font-size:14px; font-weight:600; font-family:Arial, Helvetica, sans-serif;">
                                    Academic Year : '.$syear.' - '.$nextYear.'
                                </span>
                              </div>';

                        // ✅ School details (Academic Section, Semester, Division)
