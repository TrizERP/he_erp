                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="student_status" id="student_status" class="form-control">
                                            <option value="0" @if(isset($data['activeStatus']) && $data['activeStatus']==0) selected @endif>Active Student</option>
                                            <option value="1" @if(isset($data['activeStatus']) && $data['activeStatus']==1) selected @endif>Inactive Student</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label for="first_name">First Name</label>
                                        <input type="text" name="stu_first_name" id="stu_first_name" class="form-control" @if(isset($data['stu_first_name'])) value="{{$data['stu_first_name']}}" @endif>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label for="last_name">Last Name</label>
                                        <input type="text" name="stu_last_name" id="stu_last_name" class="form-control" @if(isset($data['stu_last_name'])) value="{{$data['stu_last_name']}}" @endif>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label for="enrollment_no">Enrollment No.</label>
                                        <input type="text" name="stu_enrollment_no" id="stu_enrollment_no" class="form-control" @if(isset($data['stu_enrollment_no'])) value="{{$data['stu_enrollment_no']}}" @endif>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label for="roll_no">Roll No.</label>
                                        <input type="text" name="stu_roll_no" id="stu_roll_no" class="form-control" @if(isset($data['stu_roll_no'])) value="{{$data['stu_roll_no']}}" @endif>
                                    </div>
                                    <div class="col-md-3 form-group">
                        ...
                        <table id="example" class="table table-striped">
                            ...
                            @foreach($student_data as $key => $value)
                                ...
                                <!--<td>{{$j++}}</td>-->
                                    ...
                                    @endforeach
                                    <td><a href="{{ route('studentProfileData')}}?student_id={{$value->id}}" onclick="openPopup(this.href); return false;">Print Profile</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
