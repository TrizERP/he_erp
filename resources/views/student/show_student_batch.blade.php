    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Bulk Student Batch</h4>
            </div>
        </div>
        @php
        ...
        <div class="card">
            ...
            @endif
            <form action="{{ route('show_search_bulk_student_batch') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="row">
...
-->                
    ...
    @if(isset($data['data']))
        ...
        @endphp
        <div class="card">
            <form method="POST" action="{{ route('bulk_student_batch.update', 0) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4 form-group">
                        <label>Student Batch</label>
                        <select class="form-control" name="studentbatch" required>
                            <option value="">Select Batch</option>
                            @if(isset($data['batch_data']))
                                @foreach ($data['batch_data'] as $id => $title)
