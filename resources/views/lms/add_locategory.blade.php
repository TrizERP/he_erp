                ...
                <div class="white-box">
                    <div class="panel-body">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form
                                action="@if (isset($data['locategory_data'])) {{ route('lo_category.update', ['lo_category' => $data['locategory_data']['id']]) }}@else{{ route('lo_category.store') }} @endif"
                                        ...
                                        @if (isset($data['locategory_data']))
                                            @foreach ($data['subjects'] as $key => $value)
                                                <option value="{{ $value['subject_id'] }}"
                                                    @if (isset($data['locategory_data']['subject_id'])) @if ($data['locategory_data']['subject_id'] == $value['subject_id']) selected='selected' @endif
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id='title' name="title"
                                        value="@if (isset($data['locategory_data']['title'])) {{ $data['locategory_data']['title'] }} @endif" placeholder="Enter Statement"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id='short_code' name="short_code"
                                        value="@if (isset($data['locategory_data']['short_code'])) {{ $data['locategory_data']['short_code'] }} @endif"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id='sort_order' name="sort_order"
                                        value="@if (isset($data['locategory_data']['sort_order'])) {{ $data['locategory_data']['sort_order'] }} @endif"
                                        placeholder="Enter Sort Order"
                                        class="form-control">
                                </div>

                                <div class="col-md-4" style="display:flex;margin-top:10px;">
                                    <div class="avDiv" style="margin-right:20px;">
                                        <label>Availability</label>
                                        <div class="checkbox">
                                            <input type="checkbox" id="availability" name="availability" value="1"
                                                @if (isset($data['locategory_data']['availability']) && $data['locategory_data']['availability'] == 1) checked
                                    ...
                                    <div class="shDiv">
                                        ...
                                        <div class="checkbox">
                                            <input type="checkbox" id="show_hide" name="show_hide" value="1"
                                                @if (isset($data['locategory_data']['show_hide']) && $data['locategory_data']['show_hide'] == 1) checked
                                        @elseif(!isset($data['locategory_data']))
                                        checked @endif>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    for (var i = 0; i < result.length; i++) {
                        $("#division_id").append($("<option></option>").val(result[i]['division_id']).html(
                            result[i]['name']));
                    }
                }
            });
