          ...
          <div class="row">                
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    select master section
                     <div class="col-md-3 form-group">
                            ...
                            <select name="Slsection" id="Slsection" class="form-control">
                                ...
                                <option value="2">{{App\Helpers\get_string('standard','request')}}</option>
                                <option value="3">{{App\Helpers\get_string('division','request')}}</option>
                    ...
                    <!-- pop ups for acadmic,standard,division,subject -->
                        ...
                        <div class="col-md-12 form-group sectionstd d--none" style="display: none;">
                            <div class="row">                        
                                ...
                                <div class="col-md-3">
                                    <label>Select Next {{App\Helpers\get_string('standard','request')}}</label>
                   ...
                   <div class="col-md-12 form-group sectiondvs d--none" style="display: none;">
                        <div class="row">                            
                            <div class="col-md-3 form-group">
                                <label>Enter {{App\Helpers\get_string('division','request')}}</label>
