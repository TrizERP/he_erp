        ...
        <div class="white-box">    
            <div class="panel-body">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3">
                    <a href="{{ route('chapter_master.create') }}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</a>
                </div>
                <br><br><br>
                    ...
                    <table id="subject_list" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>    
                                ...
                                <td>{{$data->chapter_desc}}</td>     
                                <td style="display: inline-flex;">
                                    <a href="{{ route('chapter_master.edit',['id'=>$data->id,'std_id'=>$data->standard_id])}}"><button type="button" class="btn btn-info btn-outline btn-circle btn m-r-5"><i class="ti-pencil-alt"></i></button></a>                                                                        
                                    
                                    <form action="{{ route('chapter_master.destroy', $data->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
									...
									<a href="{{ route('topic_master.index',['id'=>$data->id])}}">
