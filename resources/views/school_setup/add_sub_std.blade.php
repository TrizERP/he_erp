                    ...
                    <form action="@if (isset($data['mapped_data']))
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control" data-style="form-control" name="standard_id" id="standard_id">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control" data-style="form-control" id="subject_id" name="subject_id">
                                    <option value="">Select</option>
                                    @if(isset($data['mapped_data']['standard_id']))
...
<script type="text/javascript">
    ...
    $(document).on('change', '#standard_id', function(){
        ...
        if(standard_id){
            $.ajax({
                url: '{{ route("ajax_getSubjectsByStandard") }}',
                data: {"_token": "{{csrf_token()}}", "standard_id": standard_id},
                type: 'get',
                dataType: 'json',
