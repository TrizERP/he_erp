    ...
    <div class="container-fluid">
        ...
        <center>            
            <ul class="nav nav-tabs tab-title mb-4 inst-nav">
                ...
                <li class="nav-item"><a href="#section-linemove-3" class="nav-link section-linemove-3" aria-selected="false" data-toggle="tab"><span>Institute Handbook</span></a></li>
                ...
                <li class="nav-item"><a href="#section-linemove-6" class="nav-link section-linemove-6" aria-selected="false" data-toggle="tab"><span>Club</span></a></li>
                <li class="nav-item"><a href="#section-linemove-7" class="nav-link section-linemove-7" aria-selected="false" data-toggle="tab"><span>Committee</span></a></li>
            </ul> 
        </center>
                ...
                <div class="tab-pane p-3 active" id="section-linemove-1" role="tabpanel">   
                    ...
                    @csrf
                        <div class="row">                
                            ...
                            <div class="col-md-4 form-group">
                                <label>Institute to road condition & distance</label>
...
<div class="row">
  ...
  <div class="col-md-4 form-group">
    ...
    <select class="form-control" id="clubType" name="club_type">
  ...
  <div class="col-md-4 form-group">
    <label for="facultyCoordinator" class="form-label">Faculty Coordinator</label>
    <input type="text" class="form-control" id="facultyCoordinator" name="faculty_coordinator">
  </div>

  <div class="col-md-4 form-group">
    <label for="studentPresident" class="form-label">Student President</label>
    <input type="text" class="form-control" id="studentPresident" name="student_president">
  </div>

  <div class="col-md-4 form-group">
    <label for="membersList" class="form-label">Members List</label>
    <textarea class="form-control" id="membersList" name="members_list" rows="2"></textarea>
  </div>

  <div class="col-md-4 form-group">
    <label for="activities" class="form-label">Activities / Events</label>
  ...
  <div class="col-md-4 form-group">
    <label for="formationDate" class="form-label">Date of Formation</label>
    <input type="text" class="form-control mydatepicker" id="formationDate" name="formation_date">
  </div>

  <div class="col-md-4 form-group">
    <label for="clubDescription" class="form-label">Club Description</label>
    <textarea class="form-control" id="clubDescription" name="club_description" rows="2"></textarea>
  </div>
...
<div class="col-md-4 form-group">
    ...
    <input type="text" class="form-control" id="committeeName" name="committee_name">
  </div>

  <div class="col-md-4 form-group">
    <label for="purpose" class="form-label">Purpose / Role</label>
  ...
  <div class="col-md-4 form-group">
    ...
    <textarea class="form-control" id="members" name="members" rows="2"></textarea>
  </div>

  <div class="col-md-4 form-group">
    <label for="meetingSchedule" class="form-label">Meeting Schedule</label>
    <input type="text" class="form-control" id="meetingSchedule" name="meeting_schedule">
  </div>

  <div class="col-md-4 form-group">
    <label for="termDuration" class="form-label">Term Duration</label>
    <input type="text" class="form-control" id="termDuration" name="term_duration">
  </div>

  <div class="col-md-4 form-group">
    <label for="minutes" class="form-label">Minutes of Meetings</label>
    <textarea class="form-control" id="minutes" name="minutes" rows="2"></textarea>
  </div>
