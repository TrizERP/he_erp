...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="card">
            ...
            <form action="{{ route('lo_marks_greport2.store') }}" enctype="multipart/form-data" method="post">
                @csrf
                            ...
                            <table id="example" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$datas->name}}</td>
                                        <td>{{$datas->STD}}</td>
                                        <td><a target="_blank" href="{{ route('lo_marks_greport2.store', ['id' => $datas->student_id]) }}">VIEW</a></td>
                                    </tr>
