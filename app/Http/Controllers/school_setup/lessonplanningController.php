...
class lessonplanningController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->get('lessonplan_reason') != "" && $request->get('lessonplan_status') != "" && $request->get('lessonplan_date') != "") {
            $finalArray_Exec = [
                'syear'             => $syear,
                'sub_institute_id'  => $sub_institute_id,
                'user_group_id'     => $user_profile_id,
    ...
    public function getDivisionData(Request $request, $standard_id = "")
    {
        ...
        $wherecondition = ['t.sub_institute_id' => $sub_institute_id, 't.teacher_id' => $user_id, 't.syear' => $syear];
        if ($standard_id != "") {
            $wherecondition['t.standard_id'] = $standard_id;
        }
